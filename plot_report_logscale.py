...
See LICENSE-chainer.txt

This is a change of
<\python3\Lib\site-packages\chainer\training\extensions\log_report.py>

Change 'LogScale' option add
Date April 20, 2018
By Shun
"""
...
class PlotReport2(extension.Extension):
